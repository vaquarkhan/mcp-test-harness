"""SARIF 2.3.0 export for security-tagged test failures (GitHub Code Scanning)."""
...
_SARIF_SCHEMA = "https://json.schemastore.org/sarif-2.3.0.json"
_SEVERITY_TO_LEVEL = {
    "critical": "error",
    "high": "error",
    "medium": "warning",
...
class SARIFReporter:
    """Emit SARIF 2.3.0 for failed security-tagged tests."""
