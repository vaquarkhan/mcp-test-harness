    ...
    steps:
      ...
      - uses: vaquarkhan/mcp-test-harness@v2.4.0
        ...
        with:
          ...
          harness-version: "latest"   # or pin e.g. "2.4.0"
          pr-comment: "true"
...
**Marketplace:** listed at [github.com/marketplace/actions/mcp-test-harness](https://github.com/marketplace/actions/mcp-test-harness). Pin `@v2.4.0` (or `@main`).
