    ...
    steps:
      ...
      - uses: vaquarkhan/mcp-test-harness@v3.0.6
        ...
        with:
          ...
          harness-version: "latest"   # or pin e.g. "3.0.6"
          pr-comment: "true"
...
**Marketplace:** listed at [github.com/marketplace/actions/mcp-test-harness](https://github.com/marketplace/actions/mcp-test-harness). Pin `@v3.0.6` (or `@main`).
