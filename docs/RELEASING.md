...
## Docker tags after a `v*` push (example: `v3.0.7`)

| Image | Tags (examples) |
|-------|-----------------|
| **Runtime** (default `mcp-test` entrypoint) | `ghcr.io/vaquarkhan/mcp-test-harness:3.0.7`, `:latest` |
| **Dev** (`pytest` / `[dev]` extras) | `ghcr.io/vaquarkhan/mcp-test-harness:3.0.7-dev`, `:dev` |
