...
## Docker tags after a `v*` push (example: `v3.0.3`)

| Image | Tags (examples) |
|-------|-----------------|
| **Runtime** (default `mcp-test` entrypoint) | `ghcr.io/vaquarkhan/mcp-test-harness:3.0.3`, `:latest` |
| **Dev** (`pytest` / `[dev]` extras) | `ghcr.io/vaquarkhan/mcp-test-harness:3.0.3-dev`, `:dev` |
