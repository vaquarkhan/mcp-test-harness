...
## Docker tags after a `v*` push (example: `v4.0.1`)

| Image | Tags (examples) |
|-------|-----------------|
| **Runtime** (default `mcp-test` entrypoint) | `ghcr.io/vaquarkhan/mcp-test-harness:4.0.1`, `:latest` |
| **Dev** (`pytest` / `[dev]` extras) | `ghcr.io/vaquarkhan/mcp-test-harness:4.0.1-dev`, `:dev` |
