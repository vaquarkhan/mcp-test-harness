...
| GitHub Marketplace Action + level in PR | **Shipped** | [Marketplace listing](https://github.com/marketplace/actions/mcp-test-harness); pin `@v4.0.0`+ |
...
> **Adoption complete (Tier 1).** Record-to-suite + pre-commit ship in **4.0.0**. Next: public badge wall / transport matrix.
