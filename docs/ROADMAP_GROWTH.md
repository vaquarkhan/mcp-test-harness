...
| GitHub Marketplace Action + level in PR | **Shipped** | [Marketplace listing](https://github.com/marketplace/actions/mcp-test-harness); pin `@v3.0.2`+ |
...
> **Adoption complete (Tier 1).** Record-to-suite + pre-commit ship in **3.0.2**. Next: public badge wall / transport matrix.
