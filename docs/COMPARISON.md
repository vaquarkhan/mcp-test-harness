...
3. **CI + troubleshoot** — GitHub Actions runs `mcp-test` (or `uses: vaquarkhan/mcp-test-harness@v3.0.0`). On failure, use harness output for schema/assertion detail; reopen the Inspector locally when you need raw transport traffic.
