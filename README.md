...
| `mcp-test-harness-ollama` | Ollama local models | [![PyPI](https://img.shields.io/pypi/v/mcp-test-harness-ollama)](https://pypi.org/project/mcp-test-harness-ollama/) | [![Downloads](https://static.pepy.tech/badge/mcp-test-harness-ollama)](https://pepy.tech/project/mcp-test-harness-ollama) |
| `mcp-test-harness-openrouter` | OpenRouter gateway | [![PyPI](https://img.shields.io/pypi/v/mcp-test-harness-openrouter)](https://pypi.org/project/mcp-test-harness-openrouter/) | [![Downloads](https://static.pepy.tech/badge/mcp-test-harness-openrouter)](https://pepy.tech/project/mcp-test-harness-openrouter) |
| `mcp-test-harness-litellm` | LiteLLM proxy | [![PyPI](https://img.shields.io/pypi/v/mcp-test-harness-litellm)](https://pypi.org/project/mcp-test-harness-litellm/) | [![Downloads](https://static.pepy.tech/badge/mcp-test-harness-litellm)](https://pepy.tech/project/mcp-test-harness-litellm) |
| `mcp-test-harness-xai` | xAI Grok | [![PyPI](https://img.shields.io/pypi/v/mcp-test-harness-xai)](https://pypi.org/project/mcp-test-harness-xai/) | [![Downloads](https://static.pepy.tech/badge/mcp-test-harness-xai)](https://pepy.tech/project/mcp-test-harness-xai) |
| `mcp-test-harness-autogen` | Microsoft AutoGen | [![PyPI](https://img.shields.io/pypi/v/mcp-test-harness-autogen)](https://pypi.org/project/mcp-test-harness-autogen/) | [![Downloads](https://static.pepy.tech/badge/mcp-test-harness-autogen)](https://pepy.tech/project/mcp-test-harness-autogen) |
